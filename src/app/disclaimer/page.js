      ...
      <div className={styles.legalContainer}>
        ...
        <section className={styles.legalSection}>
          ...
          <p>
            ...
            laws and regulations in their region before downloading or using any
            third-party application. We strongly recommend that you review the terms of
            service of any application before installing it on your device.
          </p>
        </section>
        ...
        <section className={styles.legalSection}>
          ...
          <p>
            We respect intellectual property rights. If you believe that any content on
            this website infringes your copyright or other intellectual property rights,
            please contact us immediately and we will investigate and take appropriate
            action, including removing the content if necessary.
          </p>
        </section>
        ...
        <section className={styles.legalSection}>
          ...
          <p>
            We reserve the right to modify this Disclaimer at any time. Updates will be
            posted on this page with a revised date. Continued use of the website after
            any changes constitutes your acceptance of the updated Disclaimer.
          </p>
        </section>
      </div>
    </div>
