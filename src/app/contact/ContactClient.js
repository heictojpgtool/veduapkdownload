    ...
    <div className={styles.legalPage}>
      <div className={styles.legalContainer}>
        ...
        <div className={styles.legalBox}>
          <p>Have a question, suggestion, or concern about Vedu APK? We are happy to hear from you. Fill out the form below or reach us through the details provided and we will get back to you as soon as possible.</p>
        </div>
        <div className={styles.contactGrid}>
          <div className={styles.contactInfo}>
            <div className={styles.infoCard}>
              <span className={styles.infoIcon}>📧</span>
              <div><h3>Email</h3><p>support@veduapk.com</p></div>
            </div>
            <div className={styles.infoCard}>
              <span className={styles.infoIcon}>⏱️</span>
              <div><h3>Response Time</h3><p>Within 24–48 hours on business days</p></div>
            </div>
            <div className={styles.infoCard}>
              <span className={styles.infoIcon}>🌐</span>
              <div><h3>Website</h3><p>veduapkdownload.com</p></div>
            </div>
            <div className={styles.infoCard}>
              <span className={styles.infoIcon}>📱</span>
              <div><h3>Support</h3><p>APK downloads, install issues, general queries</p></div>
            </div>
          </div>
